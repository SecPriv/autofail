📦
440935 /source_script_browser.js
274808 /source_script_browser.js.map
✄
...
// source_script_browser.js
var globalSequenceNumber = 0;
frida_java_bridge_default.perform(function() {
  var AutofillManager = frida_java_bridge_default.use("android.view.autofill.AutofillManager");
  var List = frida_java_bridge_default.use("java.util.List");
  var AutofillId = frida_java_bridge_default.use("android.view.autofill.AutofillId");
  var AutofillValue = frida_java_bridge_default.use("android.view.autofill.AutofillValue");
  var File2 = frida_java_bridge_default.use("java.io.File");
  var FileOutputStream = frida_java_bridge_default.use("java.io.FileOutputStream");
  ...
  function handleAutofill(sessionId, ids, values) {
    ...
    try {
      if (ids != null && values != null) {
        var idsList = frida_java_bridge_default.cast(ids, List);
        var valuesList = frida_java_bridge_default.cast(values, List);
        var size = idsList.size();
        for (var i = 0; i < size; i++) {
          var idObj = idsList.get(i);
          var afId = frida_java_bridge_default.cast(idObj, AutofillId);
          var valObj = i < valuesList.size() ? valuesList.get(i) : null;
          var valStr = "null";
          if (valObj) {
            var afVal = frida_java_bridge_default.cast(valObj, AutofillValue);
    ...
    try {
      ...
      var file = File2.$new(dir, fileName);
