...
export declare const SUPPORTED_RULE_STEP_VERSION = 2;
...
export type AutoConsentRuleStep = {
    optional?: boolean;
    comment?: string;
} & Partial<ElementExistsRule> & Partial<ElementVisibleRule> & Partial<EvalRule> & Partial<WaitForRule> & Partial<WaitForVisibleRule> & Partial<ClickRule> & Partial<WaitForThenClickRule> & Partial<WaitRule> & Partial<HideRule> & Partial<IfRule> & Partial<AnyRule> & Partial<NegatedRule> & Partial<CookieContainsRule> & Partial<RemoveClassRule> & Partial<SetStyleRule> & Partial<AddStyleRule>;
...
export type RemoveClassRule = {
    removeClass: string;
    selector: ElementSelector;
};
export type SetStyleRule = {
    setStyle: string;
    selector: ElementSelector;
};
